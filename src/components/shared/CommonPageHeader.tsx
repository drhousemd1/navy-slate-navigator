...
const CommonPageHeader: React.FC<CommonPageHeaderProps> = ({ title, rightElement }) => {
  ...
  useEffect(() => {
    console.log(`${title} header mounted, refreshing points from database`);
    refreshPointsFromDatabase();
  }, [refreshPointsFromDatabase, title]);
