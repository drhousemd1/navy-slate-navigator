...
const TasksList: React.FC<TasksListProps> = ({ 
  ...
  return (
    <div className="space-y-4">
      {tasks.map((task) => {
        console.log(`TasksList: Rendering task "${task.title}", frequency=${task.frequency}, frequency_count=${task.frequency_count}, usage_data=${JSON.stringify(task.usage_data)}`);
