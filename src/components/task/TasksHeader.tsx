...
import { Box, Coins } from 'lucide-react'; // Removed BookOpen
import { useProfilePoints } from "@/data/queries/useProfilePoints";
// Removed Link from 'react-router-dom' as it's no longer used here
  ...
  return (
    <div className="flex items-center mb-6">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Removed the Link to /app-guide from here */}
      </div>
    </div>
  );
};
