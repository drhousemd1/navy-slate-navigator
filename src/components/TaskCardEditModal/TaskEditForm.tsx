...
import { ColorPickerField, PrioritySelector, FrequencySelector, BackgroundImageSelector, IconSelector, PredefinedIconsGrid, NumberField, InputField, SwitchField } from './FormFields';
...
const TaskEditForm: React.FC<TaskEditorFormProps> = ({ 
  taskData,
  onSave,
  onDelete,
  onCancel
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <InputField control={form.control} name="title" label="Title" placeholder="Task title" />
        <InputField control={form.control} name="description" label="Description" placeholder="Task description" type="textarea" rows={5} />
