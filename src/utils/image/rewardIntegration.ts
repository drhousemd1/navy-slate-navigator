...
export const handleImageUpload = async (
  ...
  try {
    logger.debug('[Reward Image] Starting image upload and compression');
    ...
    reader.onloadend = () => {
      ...
      logger.debug('[Reward Image] Image processed and set', {
    ...
    logger.error('[Reward Image] Error processing image:', error);
    throw error;
  }
};
