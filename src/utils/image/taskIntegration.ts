...
export const handleImageUpload = async (
  ...
  try {
    logger.debug('[Task Image] Starting image upload and compression');
    ...
    reader.onloadend = () => {
      ...
      logger.debug('[Task Image] Image processed and set', {
    ...
    logger.error('[Task Image] Error processing image:', error);
    throw error;
  }
};
